...
def deal_card():
    """Returns a random card for a list of cards"""
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
...
def compare(user, computer):
    if user == computer:
        ...
        return "Dealer had BLACKJACK, You Lose!"
    elif user == 0:
...
while restart:
    ...
    start_again = input("Do you want to restart the game?, Type 'y' to start again or 'n' to exit: ")
    if start_again == 'y':
        restart = True
    else:
        restart = False
